...
bool Juego::cargarNivel() {
	...
	if (nivel == 2) {
		...
		escaleras.agregar(new Escalera(0.0f, 2.0f, 22.0f, 4.0f, 0.0f));
		...
		escaleras.agregar(new Escalera(7.0f, 9.0f, 71.0f, 4.0f, 0.0f));
		...
		escaleras.agregar(new Escalera(-9.0f, -7.0f, 71.0f, 4.0f, 0.0f));
